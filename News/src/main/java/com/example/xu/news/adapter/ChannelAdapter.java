...
public class ChannelAdapter extends BaseMultiItemQuickAdapter<Channel,BaseViewHolder> {
    ...
    protected void convert(final BaseViewHolder baseViewHolder, final Channel channel) {
        switch (baseViewHolder.getItemViewType()) {
            case Channel.TYPE_MY: // 我的频道
                //赋值，以便之后修改文字
                mEditViewHolder = baseViewHolder;
                baseViewHolder.setText(R.id.tvTitle, channel.Title).setOnClickListener(R.id.tvEdit, new View.OnClickListener() {
                    @Override
            ...
            case Channel.TYPE_MY_CHANNEL:// 我的频道列表
                ...
                baseViewHolder
                        .setText(R.id.tvChannel, channel.Title)
                ...
                break;
            case Channel.TYPE_OTHER_CHANNEL:// 频道推荐列表
                baseViewHolder
                        .setText(R.id.tvChannel, channel.Title)
